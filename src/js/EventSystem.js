const EventSystem = {
  ...
  addPetitionToHistory(petition, decision, effects) {
    this.petitionHistory.push({
      title: petition.text.substring(0, 25) + "...",
      fullText: petition.text,
      decision: decision,
      effects: effects,
      year: window.GameData.year,
      month: window.GameData.month,
    });
  },
  ...
  warTargets: [
    {
      name: "北方游牧",
      requiredMilitary: 80,
      reward: { prestige: 20, treasury: 100 },
      fail: { militaryPower: -30, prestige: -10 },
    },
    {
      name: "南方群岛",
      requiredMilitary: 50,
      reward: { prestige: 10, treasury: 60 },
      fail: { militaryPower: -15, prestige: -5 },
    },
  ],
};
